...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/zTreeStyle/zTreeStyle.css" type="text/css" rel="stylesheet" />
        <link href="${pageContext.request.contextPath}/css/jquery.validate.css" type="text/css" rel="stylesheet" />
        <link href="${pageContext.request.contextPath}/css/rmenu.css" type="text/css" rel="stylesheet" />
        ...
        <script src="${pageContext.request.contextPath}/js/common/validation/jquery.validate.js" type="text/javascript"></script>
        ...
        <script src="${pageContext.request.contextPath}/js/system/auth.js" type="text/javascript"></script>
        <style type="text/css">
